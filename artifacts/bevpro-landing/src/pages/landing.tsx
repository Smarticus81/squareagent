...
export default function Landing() {
  return (
    <div className="flex-1 bg-background text-foreground">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 min-h-[90vh] flex items-center justify-center">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 border border-border mb-12"
          >
      ...
      <div className="w-full h-px bg-border max-w-7xl mx-auto"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <div 
                key={i}
                className="bg-card border border-border p-10 flex flex-col items-start transition-colors hover:border-foreground/20"
              >
                <div className="w-12 h-12 border border-border flex items-center justify-center mb-8">
                  {step.icon}
                </div>
      ...
      <section className="py-32 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-foreground mb-10">
            {/* Minimal Square logo representation */}
            <div className="w-6 h-6 bg-foreground relative border-2 border-background">
      ...
      <section id="pricing" className="py-32 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-card border border-border p-10 md:p-12 relative">
