...
const generalAssistantSkill: SkillDefinition = {
  ...
  description: "Web search, knowledge base, email, and database access for the non-venue assistant.",
  tools: [
    ...web.definitions,
...
- Email: \`send_email\` sends from the user's configured outbound address. Always confirm recipient + subject + 1-line body summary out loud first. Never send blind.
