    ...
    <div className="flex-1 pt-24 pb-16">
      <div className="w-full max-w-[960px] mx-auto px-6 lg:px-10">
        ...
        <div className="mb-8 md:mb-10">
          ...
          <h1 className="text-[28px] md:text-[34px] font-semibold tracking-tight mt-2" style={{ color: "var(--color-vl-ink)" }}>
            Hello, {firstName}.
          </h1>
        </div>
        ...
        >
          <div
            ...
            style={{
              background:
                primary.kind === "open"
                  ? "radial-gradient(ellipse 70% 80% at 90% 10%, rgba(199,210,254,0.45), transparent 60%), radial-gradient(ellipse 60% 70% at 5% 100%, rgba(251,207,232,0.30), transparent 60%)"
                  : primary.kind === "upgrade"
                  ? "radial-gradient(ellipse 70% 80% at 90% 10%, rgba(252,165,165,0.30), transparent 60%)"
                  : "radial-gradient(ellipse 70% 80% at 90% 10%, rgba(253,230,138,0.30), transparent 60%)",
            }}
          />
          <div className="relative flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <div className="max-w-xl">
              ...
              <h2 className="text-[28px] md:text-[36px] font-semibold tracking-tight mt-3 leading-[1.1]" style={{ color: "var(--color-vl-ink)" }}>
                {primary.title}
              </h2>
              <p className="mt-3 text-[14px] leading-relaxed" style={{ color: "rgba(10,10,11,0.62)" }}>
                {primary.body}
              </p>
            </div>
            <button
        ...
        {trialActive && trialEndsAt && (
          <div className="mt-4 flex items-center justify-between gap-4 px-5 py-3 rounded-xl border border-black/[0.06] bg-white">
            ...
            <Link href="/settings" className="text-[12px] inline-flex items-center gap-1" style={{ color: "var(--color-vl-accent)" }}>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[12.5px] mt-1 leading-relaxed" style={{ color: "rgba(10,10,11,0.65)" }}>
          {copy.body}
        </p>
  ...
  return (
    <div className="flex items-start gap-4">
      <div
        ...
        style={{
          borderColor: active ? "rgba(99,102,241,0.45)" : "rgba(10,10,11,0.14)",
          color: active ? "var(--color-vl-accent)" : "rgba(10,10,11,0.50)",
      ...
      <div>
        ...
        <p className="text-[12.5px] mt-1 leading-relaxed" style={{ color: "rgba(10,10,11,0.60)" }}>
          {body}
        </p>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[12px] mt-0.5" style={{ color: "rgba(10,10,11,0.50)" }}>
          {hint}
        </p>
      </div>
      <span
